...
title: 本地游戏设置
author: cotes
date: 2025-10-25 20:55:00 +0800
categories: [UE5,Lyra]
tags: [LYRA,ui,tutorial]
pin: true
---
...
```
![质量预设](./assets/img/Pictures/游戏设置/P_QualityPresets.png "QualityPresets")
...
```
![性能控件容器](./assets/img/Pictures/游戏设置/P_LyraPerfStatContainerBase.png "P_LyraPerfStatContainerBase")
...
# 性能数据
如图所示
![性能数据](./assets/img/Pictures/游戏设置/P_PerfStatDisplayStates.png "P_PerfStatDisplayStates")
``` cpp
    //////////////////////////////////////////////////////////////////
    // Performance stats
    // 性能数据
...
![开启延迟显示](./assets/img/Pictures/游戏设置/P_EnableLatencyTracking.png "EnableLatencyTracking")
![延迟显示图表](./assets/img/Pictures/游戏设置/P_ShowLatencyTracking.png "ShowLatencyTracking")
``` cpp
