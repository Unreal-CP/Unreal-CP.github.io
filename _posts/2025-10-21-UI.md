---
title: UI
description: 在这个全面的概述中，开始学习Chirpy的基础知识。您将学习如何安装、配置和使用您的第一个基于Chirpy的网站，以及将其部署到web服务器。
author: cotes
...
```
### 蓝图调用
此处为**B_LoadRandomLobbyBackground**类的蓝图
...
```
**记得配置检索路径!**
**LyraLobbyBackground**在**ShooterMaps.GameFeatureData**中!
不配置话的就找不到这个资产!!!!
```ini
